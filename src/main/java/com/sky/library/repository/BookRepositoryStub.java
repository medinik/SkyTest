...
public class BookRepositoryStub implements BookRepository {
    ...
    private static final String THE_GRUFFALO_REFERENCE = BooksConstant.BOOK_REFERENCE_PREFIX + "GRUFF472";
    private static final String WINNIE_THE_POOH_REFERENCE = BooksConstant.BOOK_REFERENCE_PREFIX + "POOH222";
    private static final String THE_WIND_IN_THE_WILLOWS_REFERENCE = BooksConstant.BOOK_REFERENCE_PREFIX + "WILL987";
